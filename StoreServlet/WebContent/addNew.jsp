...
<table border=1 align="center">
			<tr>
				...
				<td>
					<input id="Customer_Id" required="true" placeholder="Customer ID" />
				</td>
			</tr>
			<tr>
				<td><label for="customer_Name">Customer Name</label></td>
				<td>
					<input  id="customer_Name" required="true" placeholder="Customer Name" />
				</td>
			</tr>
			<tr>
				<td><label for="customer_Address">Customer Address</label></td>
				<td>
					<input  id="customer_Address" required="true" placeholder="Customer Address" />
				</td>
			</tr>
			<tr>
...
<!-- 					<input type="radio" name="paymentMode" value="Card"/>Card -->
				<input  id="payment_Mode" required="true" placeholder="payment Mode" />
			...
			<tr>
				...
				<td>
					<input  id="retailer_id" required="true" placeholder="Retailer Id" />
				</td>
			</tr>
			<tr>
